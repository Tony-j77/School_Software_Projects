public class Youth extends Human {
    ...
    public Youth(int newYear, int newMonth, int newDay, String newFirstName, String newLastName, Gender newGender, int newGrade, String newSchoolName) { //constructor for Youth
